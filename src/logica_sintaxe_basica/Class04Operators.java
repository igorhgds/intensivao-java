...
public class Class04Operators {
    ...
    public static void main(String[] args) {
        ...
        boolean isTenEqualTwenty = 10 == 10; // not (10 == "10")
        ...
        int age = 29;
        float salary = 4700F;
        boolean isLegalOlderThanThirty = age >= 30 && salary >= 4612F;
        boolean isLegalYoungerThanThirty = age < 30 && salary >= 3381F;
