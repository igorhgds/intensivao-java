package classes_objetos_metodos.ZZBparameterization.test;

import classes_objetos_metodos.ZZBparameterization.domain.Car;
import classes_objetos_metodos.ZZBparameterization.interfaces.CarPredicate;
...
//        });
        ...
        List<Car> green = filter(cars, car -> car.getColor().equals("green")); //lambdas
